...
void main() {
  /*Set Consumer credentials before initializing the payment.
     ...
     */
  MpesaFlutterPlugin.setConsumerKey('L4YofKrHWw1odljbx2Ud5OPONreqFfwT');
  MpesaFlutterPlugin.setConsumerSecret('5BrKMGRoUfIEB9je');
...
class _MyAppState extends State<MyApp> {
  ...
  List<Map<String, dynamic>> itemsOnSale = [
    {"image": "image/invoice.jpg", "itemName": "Invoice payment", "price": 1.0}
  ];
