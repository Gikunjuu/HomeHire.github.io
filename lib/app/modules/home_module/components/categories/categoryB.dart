...
import 'package:home_hire_app/app/modules/utils/getUserName/getUserName.dart';
...
class CategoryBScreen extends StatefulWidget {
  CategoryBScreen({Key? key}) : super(key: key);

  @override
  State<CategoryBScreen> createState() => _CategoryBScreenState();
}

class _CategoryBScreenState extends State<CategoryBScreen> {
