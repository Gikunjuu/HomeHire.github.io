class Hotel {
  ...
  static List<Hotel> PeoplechoiceList() {
    return [
      Hotel('assets/images/radisonbluchittagong.webp', 'Raddison Blu', "Lorem",
          "Nyeri", 4500, 4.5),
      Hotel('assets/images/renaissance.webp', 'Renaissance', " Lorem", "Nyeri",
          4300, 4.2),
      Hotel('assets/images/soangaonroyal.png', 'Sonargaon Royal', "L'orem.",
          "Nyeri", 5500, 4.1),
      Hotel(
